...
wire [15:0] a_wire [0:7][0:7];
wire [15:0] b_wire [0:7][0:7];
wire [31:0] psum_wire [0:7][0:7];
...
endgenerate
assign c0 = psum_wire[0][7];
assign c1 = psum_wire[1][7];
assign c2 = psum_wire[2][7];
assign c3 = psum_wire[3][7];
assign c4 = psum_wire[4][7];
assign c5 = psum_wire[5][7];
assign c6 = psum_wire[6][7];
